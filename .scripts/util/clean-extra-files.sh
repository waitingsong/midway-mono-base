...
find $(find . -type d -iname "ali-oss") -maxdepth 1 -type d -iname "dist" -print0 | xargs -0i rm -rf {}

find $(find . -type d -iname "joi") -maxdepth 1 -type d -iname "dist" -print0 | xargs -0i rm -rf {}

find $(find . -type d -iname "json5") -maxdepth 1 -type d -iname "dist" -print0 | xargs -0i rm -rf {}

find $(find . -type d -iname "moment") -maxdepth 1 -type d -iname "dist" -print0 | xargs -0i rm -rf {}
...
find $(find . -type d -iname "needle") -maxdepth 1 -type d -iname "examples" -print0 | xargs -0i rm -rf {}

find $(find . -type d -iname "opentracing") -maxdepth 1 -type d -iname "src" -print0 | xargs -0i rm -rf {}
...
find $(find . -type d -iname "rxjs") -maxdepth 2 -type d -iname "bundles" -print0 | xargs -0i rm -rf {}
find $(find . -type d -iname "rxjs") -maxdepth 2 -type d -iname "esm5" -print0 | xargs -0i rm -rf {}
find $(find . -type d -iname "rxjs") -maxdepth 2 -type d -iname "esm" -print0 | xargs -0i rm -rf {}
find $(find . -type d -iname "rxjs") -maxdepth 2 -type d -iname "types" -print0 | xargs -0i rm -rf {}

find $(find . -type d -iname "sqlite3") -maxdepth 1 -type d -iname "src" -print0 | xargs -0i rm -rf {}
find $(find . -type d -iname "sqlite3") -maxdepth 1 -type d -iname "deps" -print0 | xargs -0i rm -rf {}
find $(find . -type d -iname "sqlite3") -maxdepth 1 -type d -iname "tools" -print0 | xargs -0i rm -rf {}

find $(find . -type d -iname "source-map") -maxdepth 1 -type d -iname "dist" -print0 | xargs -0i rm -rf {}

find $(find . -type d -iname "winston") -maxdepth 1 -type d -iname "dist" -print0 | xargs -0i rm -rf {}
